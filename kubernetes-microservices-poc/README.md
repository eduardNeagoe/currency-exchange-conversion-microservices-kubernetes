...
docker login
docker push eduardn08/microservices-poc-currency-exchange-service:0.0.11-SNAPSHOT
docker push eduardn08/microservices-poc-currency-conversion-service:0.0.11-SNAPSHOT
...
watch -n 0.1 curl http://34.66.241.150:8100/conversion/from/USD/to/EUR/quantity/10
